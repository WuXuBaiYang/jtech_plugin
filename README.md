...
| 子项目 | 说明 | 状态 |
| --- | --- | --- |
| [ds-deepseek-usage](./ds-deepseek-usage/) | DeepSeek 账号用量监视 —— 仿游戏风格 HP/MP 侧边栏(余额 + Token 用量,内置扫码登录 CLI,实时计数) | ✅ 已发布 [npm](https://www.npmjs.com/package/ds-deepseek-usage) |
...
│   ├── index.js              # Host 半区(服务端:同步 + 扫码登录)
│   ├── client.js             # Client 半区(浏览器 UI)
│   ├── login-cli.mjs         # 内置微信扫码登录 CLI(随包分发)
